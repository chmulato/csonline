    ...
    implements DeliveryService
{
	...
	private SendSms sendSMSFromBusinessDelivery (final SmsVO sms) throws WebException
	{
		...
		{
			throw new WebException("Informe número de celular para enviar!");
		}

		if ((sms.getFrom() == null) || (sms.getFrom().equals("")))
		{
			throw new WebException("Informe número de celular de envio!");
		}
		...
		{
			throw new WebException("Número de celular inválido!");
		}
	...
	private void sendMessageFromBusinessDelivery (final Integer deliveryId) throws WebException
	{
		...
		{
			throw new WebException("Negócio da entrega não encontrado.");
		}

		if (delivery.getCustomer() == null)
		{
			throw new WebException("Cliente da entrega não encontrado.");
		}

		if (delivery.getCourier() == null)
		{
			throw new WebException("Entregador não encontrado.");
		}
		...
		if ((delivery.getReceived()) && (!delivery.getCompleted()))
		{
			...
			message.append("Endereço base:		    ").append(delivery.getStart()).append("\r\n");
			message.append("Endereço de entrega:    ").append(delivery.getDestination()).append("\r\n");
			message.append("Distância: 	 			").append(delivery.getKm()).append(" Km\r\n");
			message.append("Contato: 	 			").append(delivery.getContact()).append("\r\n");
			message.append("Descrição: 	 			").append(delivery.getDescription()).append("\r\n");
	...
	private void sendMessageFromCustomerDelivery (final Integer deliveryId) throws WebException
	{
		...
		if (delivery.getBusiness() == null)
		{
			throw new WebException("Neg?cio da entrega não encontrado.");
		}
	...
	public List<DeliveryVO> listAllDeliveryBusinessCompleted (final Integer idBusiness) throws WebException
	{
		...
		LOGGER.info("Listar todas as entregas completas do negócio.");
	...
	public List<DeliveryVO> listAllDeliveryBusinessNotCompleted (final Integer idBusiness) throws WebException
	{
		...
		LOGGER.info("Listar todas as entregas não completadas do negócio.");
	...
	public List<DeliveryVO> listAllDeliveryCustomerNotCompleted (final Integer idCustomer) throws WebException
	{
		...
		LOGGER.info("Listar todas as entregas não completadas do cliente.");
	...
	public List<DeliveryVO> listAllDeliveryCourierNotCompleted (final Integer idCourier) throws WebException
	{
		...
		LOGGER.info("Listar todas as entregas não completadas do entregador.");
	...
	public void saveDeliveryByBusiness (final DeliveryVO delivery, final boolean send_mail, final boolean send_sms) throws WebException
	{
		...
		{
			throw new WebException("Informe descrição da entrega!");
		}

		if (delivery.getKm() == null)
		{
			throw new WebException("Informe distância!");
		}
		...
		try
		{
			...
			if (delivery.getId() == null)
			{
				...
				LOGGER.info("Salvar entrega pelo negócio.");
			...
			else
			{
				...
				LOGGER.info("Atualizar entrega pelo negócio.");

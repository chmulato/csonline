...
public interface InterfaceSQL
{
	...
	// verificar se tem entrega, se tem cliente e se tem motoboy, se OK=0 deletar negócio.
	// Inserir um negócio;
	...
	// verificar se o entregador tem entregas realizadas, se OK=0 deletar o entregador do negócio.
	// DELIVERY

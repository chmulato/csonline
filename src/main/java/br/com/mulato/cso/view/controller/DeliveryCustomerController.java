...
@Named("deliveryCustomerMB")
@RequestScoped
public class DeliveryCustomerController extends AbstractController implements Serializable {
			...
			if (isLogged) {
				...
				if (profile.equals("CUSTOMER")) {
					...
					if (loginController.getId() != null) {
						...
						idCustomer = loginController.getUserIdLogged();
						...
						setCustomer_name(customer.getName());

...
public class ReadEmails
{
	...
	public void connectionAccountMail () throws WebException
	{
		...
		try
		{
			...
			if (!deleteMessages)
			{
				LOGGER.info("--------------Início de Processamento de Leitura de Emails-----------------");
			}
			else
			{
				LOGGER.info("--------------Início de Processamento de Deletar de Emails-----------------");
			}
		...
		{
			LOGGER.error("Não foi possível acesar as mensagens! " + e.getMessage());
			throw new WebException("Não foi possível acessar as mensagens!");
		}
	}
	...
	private void readerAllMails (final Folder inbox)
	{
		...
		{
			LOGGER.error("Não foi possível ler as mensagens! " + e.getMessage());
		}
	...
	private void deleteAllMails (final Folder inbox)
	{
		...
		{
			LOGGER.error("Não foi possível deletar todas as mensagens! " + e.getMessage());
		}
	}
}

    ...
    implements DeliveryDAO, Serializable
{
	...
	@Override
	public List<DeliveryVO> listAllDeliveryBusinessCompleted (final BusinessVO business, final boolean completed) throws DAOException
	{
	...
	@Override
	public List<DeliveryVO> listAllDeliveryCustomerCompleted (final CustomerVO customer, final boolean completed) throws DAOException
	{
	...
	@Override
	public List<DeliveryVO> listAllDeliveryCourierCompleted (final CourierVO courier, final boolean completed) throws DAOException
	{

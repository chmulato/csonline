...
public class CustomerControllerTest extends BaseControllerJerseyTest {
    ...
    public void testNaoPermiteDuplicidadeDeUsuarioNoCustomer() {
        ...
        Response resp1 = target("/customers").request()
        ...
        Response resp2 = target("/customers").request()
            .header("Authorization", "Bearer " + adminToken)
            .post(jakarta.ws.rs.client.Entity.json(customerDuplicado));
    ...
    public void testGetAllCustomers() {
        ...
        String adminToken = JwtUtil.generateToken("admin_test", "ADMIN", 1L);
        target("/customers").request()
            .header("Authorization", "Bearer " + adminToken)
            .post(jakarta.ws.rs.client.Entity.json(customer));
        Response response = target("/customers").request()
            .header("Authorization", "Bearer " + adminToken)
            .get();
    ...
    public void testGetCustomerById() {
        ...
        String adminToken = JwtUtil.generateToken("admin_test", "ADMIN", 1L);
        Response createResp = target("/customers").request()
            .header("Authorization", "Bearer " + adminToken)
            .post(jakarta.ws.rs.client.Entity.json(customer));
        ...
        Response response = target("/customers/" + created.getId()).request()
            .header("Authorization", "Bearer " + adminToken)
            .get();
        assertEquals(200, response.getStatus());
    }
    ...
    public void testDeleteCustomer() {
        ...
        assertEquals(201, createResp.getStatus());
        com.caracore.cso.entity.Customer created = createResp.readEntity(com.caracore.cso.entity.Customer.class);
        Response deleteResp = target("/customers/" + created.getId()).request()
            .header("Authorization", "Bearer " + adminToken)
            .delete();
